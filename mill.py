...
def update_mill_screen(stdscr, x, y, prevx, prevy, grid, grid_size, all_mills, cleared=False):
    if cleared == True:
        stdscr.clear()
    if prevx >= 0 and prevy >= 0:
        grid[prevy][prevx] = ' '
...
def run_mill(stdscr, inv, coins, curr_mill):
    ...
    while True:
        ...
        update_mill_screen(stdscr, x, y, prevx, prevy, grid, grid_size, all_mills, cleared=clear_grid)
