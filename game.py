...
def inventory(stdscr, inv):
    ...
    stdscr.addstr(inv_len+1, 0, "j/k:scroll")
    while True:
        key = stdscr.getch()
...
def update_screen(stdscr, x, y, prevx, prevy, grid, grid_size, grid_id, cleared=False):
    ...
    stdscr.addstr(grid_size[1]+4,0,"wasd:move | q:quit | i:inventory")
    stdscr.refresh()
...
def main(stdscr):
    ...
    while True:
        ...
        update_screen(stdscr, x, y, prevx, prevy, grid, grid_size, grid_id, cleared=grid_swap)
